...
// ----------------------------------------------------------------------------
// pcl/Graphics.cpp - Released 2025-04-07T08:53:32Z
// ----------------------------------------------------------------------------
...
GraphicsContextBase::GraphicsContextBase()
   : UIObject( API_Graphics_CreateGraphics( ModuleHandle() ) )
{
   if ( IsNull() )
   ...
   : UIObject( API_Graphics_CreateGraphics( ModuleHandle() ) )
{
   ...
   if ( API_Graphics_BeginControlPaint( handle, w.handle ) == api_false )
   ...
   : UIObject( API_Graphics_CreateGraphics( ModuleHandle() ) )
{
   ...
   if ( API_Graphics_BeginBitmapPaint( handle, bmp.handle ) == api_false )
   ...
   : UIObject( API_Graphics_CreateGraphics( ModuleHandle() ) )
{
   ...
   if ( API_Graphics_BeginSVGPaint( handle, svg.handle ) == api_false )
...
{
   return API_Graphics_BeginControlPaint( handle, w.handle ) != api_false;
}
...
{
   return API_Graphics_BeginBitmapPaint( handle, pm.handle ) != api_false;
}
...
{
   return API_Graphics_BeginSVGPaint( handle, svg.handle ) != api_false;
}
...
{
   return API_Graphics_GetGraphicsStatus( handle ) != api_false;
}
...
{
   return API_Graphics_GetGraphicsTransformationEnabled( handle ) != api_false;
}
...
{
   API_Graphics_EnableGraphicsTransformation( handle, api_bool( enable ) );
}
...
{
   Matrix M( 3, 3 );
   API_Graphics_GetGraphicsTransformationMatrix(
                                       handle,
                                       &M[0][0], &M[0][1], &M[0][2],
                                       &M[1][0], &M[1][1], &M[1][2],
                                       &M[2][0], &M[2][1], &M[2][2] );
...
{
   API_Graphics_SetGraphicsTransformationMatrix( handle,
                                       M[0][0], M[0][1], M[0][2],
                                       M[1][0], M[1][1], M[1][2],
                                       M[2][0], M[2][1], M[2][2] );
}
...
{
   API_Graphics_MultiplyGraphicsTransformationMatrix( handle,
                                       M[0][0], M[0][1], M[0][2],
                                       M[1][0], M[1][1], M[1][2],
                                       M[2][0], M[2][1], M[2][2] );
}
...
{
   API_Graphics_RotateGraphicsTransformation( handle, radians );
}
...
{
   API_Graphics_ScaleGraphicsTransformation( handle, xScale, yScale );
}
...
{
   API_Graphics_TranslateGraphicsTransformation( handle, dx, dy );
}
...
{
   API_Graphics_ShearGraphicsTransformation( handle, sx, sy );
}
...
{
   API_Graphics_ResetGraphicsTransformation( handle );
}
...
{
   DPoint p( x, y );
   API_Graphics_TransformPoints( handle, reinterpret_cast<double*>( &p ), size_type( 1 ) );
   x = p.x;
   y = p.y;
}
...
{
   API_Graphics_TransformPoints( handle, reinterpret_cast<double*>( p ), n );
}
...
{
   return API_Graphics_GetGraphicsClippingEnabled( handle ) != api_false;
}
...
{
   API_Graphics_EnableGraphicsClipping( handle, api_bool( enable ) );
}
...
{
   return API_Graphics_GetGraphicsAntialiasingEnabled( handle ) != api_false;
}
...
{
   API_Graphics_EnableGraphicsAntialiasing( handle, api_bool( enable ) );
}
...
{
   return API_Graphics_GetGraphicsTextAntialiasingEnabled( handle ) != api_false;
}
...
{
   API_Graphics_EnableGraphicsTextAntialiasing( handle, api_bool( enable ) );
}
...
{
   return API_Graphics_GetGraphicsSmoothInterpolationEnabled( handle ) != api_false;
}
...
{
   API_Graphics_EnableGraphicsSmoothInterpolation( handle, api_bool( enable ) );
}
...
{
   return composition_op( API_Graphics_GetGraphicsCompositionOperator( handle ) );
}
...
{
   API_Graphics_SetGraphicsCompositionOperator( handle, op );
}
...
{
   double op;
   API_Graphics_GetGraphicsOpacity( handle, &op );
   return op;
}
...
{
   API_Graphics_SetGraphicsOpacity( handle, opc );
}
...
{
   return pcl::Brush( API_Graphics_GetGraphicsBackgroundBrush( handle ) );
}
...
{
   API_Graphics_SetGraphicsBackgroundBrush( handle, brush.handle );
}
...
{
   return API_Graphics_GetGraphicsTransparentBackgroundEnabled( handle ) != api_false;
}
...
{
   API_Graphics_SetGraphicsTransparentBackground( handle, api_bool( enable ) );
}
...
{
   return pcl::Pen( API_Graphics_GetGraphicsPen( handle ) );
}
...
{
   API_Graphics_SetGraphicsPen( handle, pen.handle );
}
...
{
   return pcl::Brush( API_Graphics_GetGraphicsBrush( handle ) );
}
...
{
   API_Graphics_SetGraphicsBrush( handle, brush.handle );
}
...
{
   return pcl::Font( API_Graphics_GetGraphicsFont( handle ) );
}
...
{
   API_Graphics_SetGraphicsFont( handle, font.handle );
}
...
{
   API_Graphics_PushGraphicsState( handle );
}
...
{
   API_Graphics_PopGraphicsState( handle );
}
...
{
   pcl::Rect r;
   API_Graphics_GetGraphicsClipRect( handle, &r.x0, &r.y0, &r.x1, &r.y1 );
   return r;
}
...
{
   API_Graphics_SetGraphicsClipRect( handle, x0, y0, x1, y1 );
}
...
{
   pcl::Point p;
   API_Graphics_GetGraphicsBrushOrigin( handle, &p.x, &p.y );
   return p;
}
...
{
   API_Graphics_SetGraphicsBrushOrigin( handle, x, y );
}
...
{
   API_Graphics_DrawPoint( handle, x, y );
}
...
{
   API_Graphics_DrawLine( handle, x0, y0, x1, y1 );
}
...
{
   API_Graphics_DrawRect( handle, x0, y0, x1, y1 );
}
...
{
   API_Graphics_StrokeRect( handle, x0, y0, x1, y1, pen.handle );
}
...
{
   API_Graphics_FillRect( handle, x0, y0, x1, y1, brush.handle );
}
...
{
   API_Graphics_DrawRoundedRect( handle, x0, y0, x1, y1, rx, ry );
}
...
{
   API_Graphics_StrokeRoundedRect( handle, x0, y0, x1, y1, rx, ry, pen.handle );
}
...
{
   API_Graphics_StrokeRoundedRect( handle, x0, y0, x1, y1, rx, ry, brush.handle );
}
...
{
   API_Graphics_DrawEllipse( handle, x0, y0, x1, y1 );
}
...
{
   API_Graphics_StrokeEllipse( handle, x0, y0, x1, y1, pen.handle );
}
...
{
   API_Graphics_FillEllipse( handle, x0, y0, x1, y1, brush.handle );
}
...
{
   API_Graphics_DrawPolygon( handle, reinterpret_cast<const int32*>( p ), n, rule );
}
...
{
   API_Graphics_StrokePolygon( handle, reinterpret_cast<const int32*>( p ), n, rule, pen.handle );
}
...
{
   API_Graphics_FillPolygon( handle, reinterpret_cast<const int32*>( p ), n, rule, brush.handle );
}
...
{
   API_Graphics_DrawPolyline( handle, reinterpret_cast<const int32*>( points ), n );
}
...
{
   API_Graphics_DrawArc( handle, x0, y0, x1, y1, start, span );
}
...
{
   API_Graphics_DrawChord( handle, x0, y0, x1, y1, start, span );
}
...
{
   API_Graphics_StrokeChord( handle, x0, y0, x1, y1, start, span, pen.handle );
}
...
{
   API_Graphics_FillChord( handle, x0, y0, x1, y1, start, span, brush.handle );
}
...
{
   API_Graphics_DrawPie( handle, x0, y0, x1, y1, start, span );
}
...
{
   API_Graphics_StrokePie( handle, x0, y0, x1, y1, start, span, pen.handle );
}
...
{
   API_Graphics_FillPie( handle, x0, y0, x1, y1, start, span, brush.handle );
}
...
{
   API_Graphics_DrawBitmap( handle, x, y, bm.handle );
}
...
{
   API_Graphics_DrawBitmapRect( handle, x, y, bm.handle, x0, y0, x1, y1 );
}
...
{
   API_Graphics_DrawScaledBitmap( handle, x0, y0, x1, y1, bm.handle );
}
...
{
   API_Graphics_DrawScaledBitmapRect( handle, dx0, dy0, dx1, dy1, bm.handle, sx0, sy0, sx1, sy1 );
}
...
{
   API_Graphics_DrawTiledBitmap( handle, x0, y0, x1, y1, bm.handle, ox, oy );
}
...
{
   API_Graphics_DrawText( handle, x, y, s.c_str() );
}
...
{
   API_Graphics_DrawTextRect( handle, x0, y0, x1, y1, s.c_str(), align );
}
...
{
   pcl::Rect r;
   API_Graphics_GetTextRect( handle, x0, y0, x1, y1, s.c_str(), align, &r.x0, &r.y0, &r.x1, &r.y1 );
   return r;
}
...
{
   pcl::DRect r;
   API_Graphics_GetGraphicsClipRectD( handle, &r.x0, &r.y0, &r.x1, &r.y1 );
   return r;
}
...
{
   API_Graphics_SetGraphicsClipRectD( handle, x0, y0, x1, y1 );
}
...
{
   pcl::DPoint p;
   API_Graphics_GetGraphicsBrushOriginD( handle, &p.x, &p.y );
   return p;
}
...
{
   API_Graphics_SetGraphicsBrushOriginD( handle, x, y );
}
...
{
   API_Graphics_DrawPointD( handle, x, y );
}
...
{
   API_Graphics_DrawLineD( handle, x0, y0, x1, y1 );
}
...
{
   API_Graphics_DrawRectD( handle, x0, y0, x1, y1 );
}
...
{
   API_Graphics_StrokeRectD( handle, x0, y0, x1, y1, pen.handle );
}
...
{
   API_Graphics_FillRectD( handle, x0, y0, x1, y1, brush.handle );
}
...
{
   API_Graphics_DrawRoundedRectD( handle, x0, y0, x1, y1, rx, ry );
}
...
{
   API_Graphics_StrokeRoundedRectD( handle, x0, y0, x1, y1, rx, ry, pen.handle );
}
...
{
   API_Graphics_StrokeRoundedRectD( handle, x0, y0, x1, y1, rx, ry, brush.handle );
}
...
{
   API_Graphics_DrawEllipseD( handle, x0, y0, x1, y1 );
}
...
{
   API_Graphics_StrokeEllipseD( handle, x0, y0, x1, y1, pen.handle );
}
...
{
   API_Graphics_FillEllipseD( handle, x0, y0, x1, y1, brush.handle );
}
...
{
   API_Graphics_DrawPolygonD( handle, reinterpret_cast<const double*>( p ), n, rule );
}
...
{
   API_Graphics_StrokePolygonD( handle, reinterpret_cast<const double*>( p ), n, rule, pen.handle );
}
...
{
   API_Graphics_FillPolygonD( handle, reinterpret_cast<const double*>( p ), n, rule, brush.handle );
}
...
{
   API_Graphics_DrawPolylineD( handle, reinterpret_cast<const double*>( points ), n );
}
...
{
   API_Graphics_DrawArcD( handle, x0, y0, x1, y1, start, span );
}
...
{
   API_Graphics_DrawChordD( handle, x0, y0, x1, y1, start, span );
}
...
{
   API_Graphics_StrokeChordD( handle, x0, y0, x1, y1, start, span, pen.handle );
}
...
{
   API_Graphics_FillChordD( handle, x0, y0, x1, y1, start, span, brush.handle );
}
...
{
   API_Graphics_DrawPieD( handle, x0, y0, x1, y1, start, span );
}
...
{
   API_Graphics_StrokePieD( handle, x0, y0, x1, y1, start, span, pen.handle );
}
...
{
   API_Graphics_FillPieD( handle, x0, y0, x1, y1, start, span, brush.handle );
}
...
{
   API_Graphics_DrawBitmapD( handle, x, y, bm.handle );
}
...
{
   API_Graphics_DrawBitmapRectD( handle, x, y, bm.handle, x0, y0, x1, y1 );
}
...
{
   API_Graphics_DrawScaledBitmapD( handle, x0, y0, x1, y1, bm.handle );
}
...
{
   API_Graphics_DrawScaledBitmapRectD( handle, dx0, dy0, dx1, dy1, bm.handle, sx0, sy0, sx1, sy1 );
}
...
{
   API_Graphics_DrawTiledBitmapD( handle, x0, y0, x1, y1, bm.handle, ox, oy );
}
...
{
   API_Graphics_DrawTextD( handle, x, y, s.c_str() );
}
...
{
   API_Graphics_DrawTextRectD( handle, x0, y0, x1, y1, s.c_str(), align );
}
...
{
   pcl::DRect r;
   API_Graphics_GetTextRectD( handle, x0, y0, x1, y1, s.c_str(), align, &r.x0, &r.y0, &r.x1, &r.y1 );
   return r;
}
...
// ----------------------------------------------------------------------------
// EOF pcl/Graphics.cpp - Released 2025-04-07T08:53:32Z
