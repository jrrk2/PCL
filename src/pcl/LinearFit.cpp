...
{
   switch ( API_Numerical_LinearFitF( &a, &b, &adev, fx, fy, n, status ? LinearFitCallback : nullptr, status ) )
   {
   case api_ok:
      return;
   default:
...
{
   switch ( API_Numerical_LinearFitD( &a, &b, &adev, fx, fy, n, status ? LinearFitCallback : nullptr, status ) )
   {
   case api_ok:
      return;
   default:
