...
// ----------------------------------------------------------------------------
// pcl/Variant.cpp - Released 2025-04-07T08:53:32Z
// ----------------------------------------------------------------------------
...
IsoStringList Variant::ToIsoStringList() const
{
   ...
   case VariantType::StringList:
      {
         IsoStringList list;
         for ( const String& string : *m_data.stringListValue )
            list << IsoString( string );
         return list;
      }
   case VariantType::IsoStringList:
...
// ----------------------------------------------------------------------------
// EOF pcl/Variant.cpp - Released 2025-04-07T08:53:32Z
