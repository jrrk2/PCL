...
// ----------------------------------------------------------------------------
// pcl/MetaFileFormat.cpp - Released 2025-04-07T08:53:32Z
// ----------------------------------------------------------------------------
...
{
   API_FileFormatDefinition_EnterFileFormatDefinitionContext();

   {
      ...
      API_FileFormatDefinition_BeginFileFormatDefinition( this, name.c_str(), cext.Begin(), cmime.Begin() );
   }

   API_FileFormatDefinition_SetFileFormatVersion( Version() );

   {
      String desc = Description();
      if ( !desc.IsEmpty() )
         API_FileFormatDefinition_SetFileFormatDescription( desc.c_str() );
   }

   {
      String impl = Implementation();
      if ( !impl.IsEmpty() )
         API_FileFormatDefinition_SetFileFormatImplementation( impl.c_str() );
   }

   {
      IsoString svg = IconImageSVG();
      if ( !svg.IsEmpty() )
         API_FileFormatDefinition_SetFileFormatIconSVG( svg.c_str() );
      else
      {
         String filePath = IconImageSVGFile();
         if ( !filePath.IsEmpty() )
            API_FileFormatDefinition_SetFileFormatIconSVGFile( filePath.c_str() );
         else
         {
            ...
            const char** xpm = IconImageXPM();
            if ( xpm != nullptr )
               API_FileFormatDefinition_SetFileFormatIconImage( xpm );
            else
            {
               String path = IconImageFile();
               if ( !path.IsEmpty() )
                  API_FileFormatDefinition_SetFileFormatIconImageFile( path.c_str() );
            }

            xpm = SmallIconImageXPM();
            if ( xpm != nullptr )
               API_FileFormatDefinition_SetFileFormatIconSmallImage( xpm );
            else
            {
               String path = SmallIconImageFile();
               if ( !path.IsEmpty() )
                  API_FileFormatDefinition_SetFileFormatIconSmallImageFile( path.c_str() );
            }
         }
      }
   }
   ...
   API_FileFormatDefinition_SetFileFormatCaps( &caps );

   API_FileFormatDefinition_SetFileFormatCreationRoutine( FileFormatDispatcher::CreateFileFormat );
   API_FileFormatDefinition_SetFileFormatDestructionRoutine( FileFormatDispatcher::DestroyFileFormat );
   API_FileFormatDefinition_SetFileFormatValidateFormatSpecificDataRoutine( FileFormatDispatcher::ValidateFormatSpecificData );
   API_FileFormatDefinition_SetFileFormatDisposeFormatSpecificDataRoutine( FileFormatDispatcher::DisposeFormatSpecificData );
   API_FileFormatDefinition_SetFileFormatEditPreferencesRoutine( FileFormatDispatcher::EditFileFormatPreferences );
   API_FileFormatDefinition_SetFileFormatOpenRoutine( FileFormatDispatcher::Open );
   API_FileFormatDefinition_SetFileFormatGetImageCountRoutine( FileFormatDispatcher::GetImageCount );
   API_FileFormatDefinition_SetFileFormatGetImageIdRoutine( FileFormatDispatcher::GetImageId );
   API_FileFormatDefinition_SetFileFormatGetImageDescriptionRoutine( FileFormatDispatcher::GetImageDescription );
   API_FileFormatDefinition_SetFileFormatCloseRoutine( FileFormatDispatcher::Close );
   API_FileFormatDefinition_SetFileFormatIsOpenRoutine( FileFormatDispatcher::IsOpen );
   API_FileFormatDefinition_SetFileFormatGetFilePathRoutine( FileFormatDispatcher::FilePath );
   API_FileFormatDefinition_SetFileFormatSetSelectedImageIndexRoutine( FileFormatDispatcher::SelectImage );
   API_FileFormatDefinition_SetFileFormatGetSelectedImageIndexRoutine( FileFormatDispatcher::SelectedImageIndex );
   API_FileFormatDefinition_SetFileFormatSetFormatSpecificDataRoutine( FileFormatDispatcher::SetFormatSpecificData );
   API_FileFormatDefinition_SetFileFormatGetFormatSpecificDataRoutine( FileFormatDispatcher::GetFormatSpecificData );
   API_FileFormatDefinition_SetFileFormatGetImageFormatInfoRoutine( FileFormatDispatcher::GetImageFormatInfo );
   API_FileFormatDefinition_SetFileFormatBeginKeywordExtractionRoutine( FileFormatDispatcher::BeginKeywordExtraction );
   API_FileFormatDefinition_SetFileFormatGetKeywordCountRoutine( FileFormatDispatcher::GetKeywordCount );
   API_FileFormatDefinition_SetFileFormatGetNextKeywordRoutine( FileFormatDispatcher::GetNextKeyword );
   API_FileFormatDefinition_SetFileFormatEndKeywordExtractionRoutine( FileFormatDispatcher::EndKeywordExtraction );
   API_FileFormatDefinition_SetFileFormatBeginICCProfileExtractionRoutine( FileFormatDispatcher::BeginICCProfileExtraction );
   API_FileFormatDefinition_SetFileFormatGetICCProfileRoutine( FileFormatDispatcher::GetICCProfile );
   API_FileFormatDefinition_SetFileFormatEndICCProfileExtractionRoutine( FileFormatDispatcher::EndICCProfileExtraction );
   API_FileFormatDefinition_SetFileFormatBeginThumbnailExtractionRoutine( FileFormatDispatcher::BeginThumbnailExtraction );
   API_FileFormatDefinition_SetFileFormatGetThumbnailRoutine( FileFormatDispatcher::GetThumbnail );
   API_FileFormatDefinition_SetFileFormatEndThumbnailExtractionRoutine( FileFormatDispatcher::EndThumbnailExtraction );
   API_FileFormatDefinition_SetFileFormatEnumeratePropertiesRoutine( FileFormatDispatcher::EnumerateProperties );
   API_FileFormatDefinition_SetFileFormatBeginPropertyExtractionRoutine( FileFormatDispatcher::BeginPropertyExtraction );
   API_FileFormatDefinition_SetFileFormatGetPropertyRoutine( FileFormatDispatcher::GetProperty );
   API_FileFormatDefinition_SetFileFormatEndPropertyExtractionRoutine( FileFormatDispatcher::EndPropertyExtraction );
   API_FileFormatDefinition_SetFileFormatBeginPropertyEmbeddingRoutine( FileFormatDispatcher::BeginPropertyEmbedding );
   API_FileFormatDefinition_SetFileFormatSetPropertyRoutine( FileFormatDispatcher::SetProperty );
   API_FileFormatDefinition_SetFileFormatEndPropertyEmbeddingRoutine( FileFormatDispatcher::EndPropertyEmbedding );
   API_FileFormatDefinition_SetFileFormatEnumerateImagePropertiesRoutine( FileFormatDispatcher::EnumerateImageProperties );
   API_FileFormatDefinition_SetFileFormatBeginImagePropertyExtractionRoutine( FileFormatDispatcher::BeginImagePropertyExtraction );
   API_FileFormatDefinition_SetFileFormatGetImagePropertyRoutine( FileFormatDispatcher::GetImageProperty );
   API_FileFormatDefinition_SetFileFormatEndImagePropertyExtractionRoutine( FileFormatDispatcher::EndImagePropertyExtraction );
   API_FileFormatDefinition_SetFileFormatBeginImagePropertyEmbeddingRoutine( FileFormatDispatcher::BeginImagePropertyEmbedding );
   API_FileFormatDefinition_SetFileFormatSetImagePropertyRoutine( FileFormatDispatcher::SetImageProperty );
   API_FileFormatDefinition_SetFileFormatEndImagePropertyEmbeddingRoutine( FileFormatDispatcher::EndImagePropertyEmbedding );
   API_FileFormatDefinition_SetFileFormatBeginRGBWSExtractionRoutine( FileFormatDispatcher::BeginRGBWSExtraction );
   API_FileFormatDefinition_SetFileFormatGetImageRGBWSRoutine( FileFormatDispatcher::GetImageRGBWS );
   API_FileFormatDefinition_SetFileFormatEndRGBWSExtractionRoutine( FileFormatDispatcher::EndRGBWSExtraction );
   API_FileFormatDefinition_SetFileFormatBeginRGBWSEmbeddingRoutine( FileFormatDispatcher::BeginRGBWSEmbedding );
   API_FileFormatDefinition_SetFileFormatSetImageRGBWSRoutine( FileFormatDispatcher::SetImageRGBWS );
   API_FileFormatDefinition_SetFileFormatEndRGBWSEmbeddingRoutine( FileFormatDispatcher::EndRGBWSEmbedding );
   API_FileFormatDefinition_SetFileFormatBeginDisplayFunctionExtractionRoutine( FileFormatDispatcher::BeginDisplayFunctionExtraction );
   API_FileFormatDefinition_SetFileFormatGetImageDisplayFunctionRoutine( FileFormatDispatcher::GetImageDisplayFunction );
   API_FileFormatDefinition_SetFileFormatEndDisplayFunctionExtractionRoutine( FileFormatDispatcher::EndDisplayFunctionExtraction );
   API_FileFormatDefinition_SetFileFormatBeginDisplayFunctionEmbeddingRoutine( FileFormatDispatcher::BeginDisplayFunctionEmbedding );
   API_FileFormatDefinition_SetFileFormatSetImageDisplayFunctionRoutine( FileFormatDispatcher::SetImageDisplayFunction );
   API_FileFormatDefinition_SetFileFormatEndDisplayFunctionEmbeddingRoutine( FileFormatDispatcher::EndDisplayFunctionEmbedding );
   API_FileFormatDefinition_SetFileFormatBeginColorFilterArrayExtractionRoutine( FileFormatDispatcher::BeginColorFilterArrayExtraction );
   API_FileFormatDefinition_SetFileFormatGetImageColorFilterArrayRoutine( FileFormatDispatcher::GetImageColorFilterArray );
   API_FileFormatDefinition_SetFileFormatEndColorFilterArrayExtractionRoutine( FileFormatDispatcher::EndColorFilterArrayExtraction );
   API_FileFormatDefinition_SetFileFormatBeginColorFilterArrayEmbeddingRoutine( FileFormatDispatcher::BeginColorFilterArrayEmbedding );
   API_FileFormatDefinition_SetFileFormatSetImageColorFilterArrayRoutine( FileFormatDispatcher::SetImageColorFilterArray );
   API_FileFormatDefinition_SetFileFormatEndColorFilterArrayEmbeddingRoutine( FileFormatDispatcher::EndColorFilterArrayEmbedding );
   API_FileFormatDefinition_SetFileFormatReadImageRoutine( FileFormatDispatcher::ReadImage );
   API_FileFormatDefinition_SetFileFormatAllowIncrementalReadRoutine( FileFormatDispatcher::AllowIncrementalRead );
   API_FileFormatDefinition_SetFileFormatReadSamplesRoutine( FileFormatDispatcher::ReadSamples );
   API_FileFormatDefinition_SetFileFormatQueryOptionsRoutine( FileFormatDispatcher::QueryImageFileOptions );
   API_FileFormatDefinition_SetFileFormatCreateRoutine( FileFormatDispatcher::Create );
   API_FileFormatDefinition_SetFileFormatSetImageIdRoutine( FileFormatDispatcher::SetImageId );
   API_FileFormatDefinition_SetFileFormatSetImageOptionsRoutine( FileFormatDispatcher::SetImageOptions );
   API_FileFormatDefinition_SetFileFormatCreateImageRoutine( FileFormatDispatcher::CreateImage );
   API_FileFormatDefinition_SetFileFormatCloseImageRoutine( FileFormatDispatcher::CloseImage );
   API_FileFormatDefinition_SetFileFormatBeginKeywordEmbeddingRoutine( FileFormatDispatcher::BeginKeywordEmbedding );
   API_FileFormatDefinition_SetFileFormatAddKeywordRoutine( FileFormatDispatcher::AddKeyword );
   API_FileFormatDefinition_SetFileFormatEndKeywordEmbeddingRoutine( FileFormatDispatcher::EndKeywordEmbedding );
   API_FileFormatDefinition_SetFileFormatBeginICCProfileEmbeddingRoutine( FileFormatDispatcher::BeginICCProfileEmbedding );
   API_FileFormatDefinition_SetFileFormatSetICCProfileRoutine( FileFormatDispatcher::SetICCProfile );
   API_FileFormatDefinition_SetFileFormatEndICCProfileEmbeddingRoutine( FileFormatDispatcher::EndICCProfileEmbedding );
   API_FileFormatDefinition_SetFileFormatBeginThumbnailEmbeddingRoutine( FileFormatDispatcher::BeginThumbnailEmbedding );
   API_FileFormatDefinition_SetFileFormatSetThumbnailRoutine( FileFormatDispatcher::SetThumbnail );
   API_FileFormatDefinition_SetFileFormatEndThumbnailEmbeddingRoutine( FileFormatDispatcher::EndThumbnailEmbedding );
   API_FileFormatDefinition_SetFileFormatWriteImageRoutine( FileFormatDispatcher::WriteImage );
   API_FileFormatDefinition_SetFileFormatAllowIncrementalWriteRoutine( FileFormatDispatcher::AllowIncrementalWrite );
   API_FileFormatDefinition_SetFileFormatWriteSamplesRoutine( FileFormatDispatcher::WriteSamples );
   API_FileFormatDefinition_SetFileFormatQueryInexactReadRoutine( FileFormatDispatcher::QueryInexactRead );
   API_FileFormatDefinition_SetFileFormatQueryLossyWriteRoutine( FileFormatDispatcher::QueryLossyWrite );
   API_FileFormatDefinition_SetFileFormatQueryFormatStatusRoutine( FileFormatDispatcher::QueryFormatStatus );

   API_FileFormatDefinition_EndFileFormatDefinition();

   API_FileFormatDefinition_ExitFileFormatDefinitionContext();
}
...
// ----------------------------------------------------------------------------
// EOF pcl/MetaFileFormat.cpp - Released 2025-04-07T08:53:32Z
