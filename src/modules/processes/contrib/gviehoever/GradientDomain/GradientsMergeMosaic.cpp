...
// ----------------------------------------------------------------------------
// GradientsMergeMosaic.cpp - Released 2025-02-19T18:29:34Z
// ----------------------------------------------------------------------------
   ...
   weightImageType_t& rCountImageDx_p, weightImageType_t& rCountImageDy_p )
{
   ...
   for ( int row = 0; row < nRows; ++row )
   {
      for ( int col = 0; col < nCols - 1; ++col )
      {
         ...
         else if ( rCountImageDx_p.Pixel( col, row ) == 0.0 && ( rMask_p.Pixel( col, row ) < 0.0 || rMask_p.Pixel( col + 1, row ) < 0.0 ) )
         {
   ...
   for ( int row = 0; row < nRows - 1; ++row )
   {
      for ( int col = 0; col < nCols; ++col )
      {
         ...
         else if ( rCountImageDy_p.Pixel( col, row ) == 0.0 && ( rMask_p.Pixel( col, row ) < 0.0 || rMask_p.Pixel( col, row + 1 ) < 0.0 ) )
         {
...
// ----------------------------------------------------------------------------
// EOF GradientsMergeMosaic.cpp - Released 2025-02-19T18:29:34Z
