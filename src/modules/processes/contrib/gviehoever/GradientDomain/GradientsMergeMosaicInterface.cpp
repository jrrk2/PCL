...
// ----------------------------------------------------------------------------
// GradientsMergeMosaicInterface.cpp - Released 2025-01-09T18:44:32Z
// ----------------------------------------------------------------------------
...
String GradientsMergeMosaicInterface::IconImageSVGFile() const
{
   return "@module_icons_dir/GradientMergeMosaic.svg";
}
...
void GradientsMergeMosaicInterface::__GenerateMaskClicked( Button& sender, bool checked )
{
...
GradientsMergeMosaicInterface::GUIData::GUIData( GradientsMergeMosaicInterface& w )
{
   ...
   GenerateMask_CheckBox.OnClick( (pcl::Button::click_event_handler)&GradientsMergeMosaicInterface::__GenerateMaskClicked, w );
...
// ----------------------------------------------------------------------------
// EOF GradientsMergeMosaicInterface.cpp - Released 2025-01-09T18:44:32Z
