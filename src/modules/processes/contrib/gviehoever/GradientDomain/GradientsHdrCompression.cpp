...
// ----------------------------------------------------------------------------
// GradientsHdrCompression.cpp - Released 2025-01-09T18:44:32Z
// ----------------------------------------------------------------------------
...
void GradientsHdrCompression::hdrCompressionSetImage( imageType_t const& rImage_p )
{
...
//static
void GradientsHdrCompression::minMaxValImage( imageType_t const& rImage_p, realType_t& rdMin_p, realType_t& rdMax_p )
{
   AssertImage( rImage_p );
...
//static
void GradientsHdrCompression::clipImage( imageType_t& rImage_p, realType_t minRange_p, realType_t maxRange_p )
{
   AssertImage( rImage_p );
...
//static
void GradientsHdrCompression::zeroRangeImage( imageType_t& rImage_p, realType_t minRange_p, realType_t maxRange_p )
{
   AssertImage( rImage_p );
   Assert( maxRange_p >= minRange_p );
...
//static
void GradientsHdrCompression::absPowImage( imageType_t& rImage_p, realType_t exponent_p )
{
   AssertImage( rImage_p );
...
// ----------------------------------------------------------------------------
// EOF GradientsHdrCompression.cpp - Released 2025-01-09T18:44:32Z
