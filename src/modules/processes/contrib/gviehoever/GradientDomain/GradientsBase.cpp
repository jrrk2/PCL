...
// ----------------------------------------------------------------------------
// GradientsBase.cpp - Released 2025-01-09T18:44:32Z
// ----------------------------------------------------------------------------
...
//static
void GradientsBase::AssertImage( imageType_t const& rImage_p )
{
...
void GradientsBase::AssertColImage( imageType_t const& rImage_p )
{
   Assert( rImage_p.Height() > 2 );
   Assert( rImage_p.Width() > 2 );
   Assert( rImage_p.NumberOfChannels() >= 1 );
...
//static
void GradientsBase::createDxImage( imageType_t const& rImage_p, imageType_t& rResultImage_p )
{
...
//static
void GradientsBase::createDyImage( imageType_t const& rImage_p, imageType_t& rResultImage_p )
{
   AssertColImage( rImage_p );
   int const nRows = rImage_p.Height();
   int const nCols = rImage_p.Width();
...
//static
void GradientsBase::createLaplaceVonNeumannImage( imageType_t const& rDx_p, imageType_t const rDy_p,
...
//static
void GradientsBase::solveImage( imageType_t const& rLaplaceImage_p, imageType_t& rSolution_p )
{
...
void GradientsBase::TimeMessage::Stop()
{
   ...
   double seconds = ( endTv.tv_sec - m_startTv.tv_sec ) + ( endTv.tv_usec - m_startTv.tv_usec ) / 1000000.0;
   double minutes, hours;
   Split( seconds / 60, minutes, seconds );
   seconds *= 60;
   Split( minutes / 60, hours, minutes );
   minutes *= 60;
...
// ----------------------------------------------------------------------------
// EOF GradientsBase.cpp - Released 2025-01-09T18:44:32Z
