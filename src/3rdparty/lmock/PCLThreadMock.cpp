...
static ThreadData* get_thread_data(const void* handle) {
...
api_bool SetThreadExecRoutine(thread_handle thread_handle, pcl::thread_exec_routine dispatcher) {
...
api_bool IsThreadActive(const void* thread_handle) {
