...
// ============================================================================
// Gaia catalog plate solver (PixInsight ImageSolver technique)
//
// Algorithm:
//   1. Detect stars with PCL StarDetector + PSF fitting
//   2. Query Gaia DR3 XPSD catalog for reference stars
//   3. Project catalog stars onto image plane via gnomonic projection
//   4. Match image stars to catalog via triangle descriptor matching
//   5. Fit homography from matched pairs
//   6. Optionally fit surface splines for distortion correction
//   7. Iteratively refine by re-matching with improved WCS
// ============================================================================

static bool PlateSolveGaia( const Image& image, SimpleTANWCS& wcs,
...
static std::string g_gaiaAstroDbPath; // Path to Gaia astrometry XPSD for catalog solver
...
int main( int argc, char** argv )
{
   ...
   try
   {
      ...
      tanWcs.BuildFromMetadata( properties, keywords );
